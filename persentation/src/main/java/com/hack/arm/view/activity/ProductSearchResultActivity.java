...
import com.hack.arm.internal.di.components.DaggerProductComponent;
...
public class ProductSearchResultActivity extends BaseDrawerActivity
    ...
    @BindView(com.hack.arm.R.id.fragmentContainer)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.hack.arm.R.layout.activity_list_product);
    ...
    private void initializeActivity(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            ...
            addFragment(com.hack.arm.R.id.fragmentContainer, new ListProductFragment());
